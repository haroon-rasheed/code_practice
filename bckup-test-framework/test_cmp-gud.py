...
class TestDSFiles(unittest.TestCase):
	def runTest(self):
		test_runner = CheckDSFiles()
		#assert test_runner.testMain()
		test_runner.testMain()


class CheckDSFiles(object):
		...
		def testMain(self):
			...
			self.testCompareResult(act_res_path, exp_res_path)
			#sys.exit(0)



		def testCompareResult(self,act_res_path, exp_res_path):
