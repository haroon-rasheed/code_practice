...
class VerifyDSFiles(object):
	...
	def main(self):
		...
		act_res_path, exp_res_path = self.validate_input_dirs(args)
		...
		if options.c:
			...
			self.run_result_check(dcmp)


	def validate_input_dirs(self, args):
		"""
	...
	def run_result_check(self, dcmp):
		"""
		...
		if ( len(dcmp.diff_files) > 0 ):
			...
			self.compare_results_verbose(dcmp)
			return "Mismatch-BUG"
		else:
	...
	def compare_results_verbose(self, dcmp):
		"""
